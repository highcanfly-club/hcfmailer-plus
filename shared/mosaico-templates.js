...
function getVersafix(tagLanguage) {
    ...
    const versafix = '<!DOCTYPE html>\n' +
        ...
        '        widget: select;\n' +
        '        options: [LINK_PREFERENCES]=Profile|[LINK_UNSUBSCRIBE]=Unsubscribe|none=None;\n' +
        ...
        '          \n' +
        '            <tr data-ko-display="preheaderLinkOption neq \'none\'"><td width="100%" valign="top" style="font-weight: normal; color: #ffffff; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; -ko-font-size: @[linkStyle.size]px; -ko-color: @linkStyle.color; -ko-font-family: @linkStyle.face" align="left"><a style="color: #ffffff; text-decoration: underline; -ko-attr-href: @[preheaderLinkOption]; -ko-color: @linkStyle.color; -ko-text-decoration: @linkStyle.decoration" href="[LINK_UNSUBSCRIBE]" data-ko-editable="unsubscribeText">Unsubscribe</a></td></tr>\n' +
        ...
        '        --><table role="presentation" class="vb-content" border="0" cellspacing="9" cellpadding="0" style="border-collapse: separate; width: 100%; mso-cellspacing: 9px; border-spacing: 9px; -yandex-p: calc(2px - 3%)" width="276" align="left">\n' +
        '          \n' +
        '            <tr><td width="100%" valign="top" style="font-weight: normal; color: #ffffff; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: right; -ko-font-size: @[linkStyle.size]px; -ko-color: @linkStyle.color; -ko-font-family: @linkStyle.face" align="right"><a style="color: #ffffff; text-decoration: underline; -ko-color: @linkStyle.color; -ko-text-decoration: @linkStyle.decoration" href="[LINK_BROWSER]" data-ko-editable="webversionText">View in your browser</a></td></tr>\n' +
        '          \n' +
        '        </table><!--\n' +
        '      --></div><!--[if (gte mso 9)|(lte ie 8)]></td><![endif]--><!--\n' +
        '        --><!--\n' +
