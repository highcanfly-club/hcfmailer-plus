...
import { enableDeleteModal } from "../settings/settings";const CUD =
  ...
  constructor(props) {
    ...
    this.initForm({
      ...
      onChangeBeforeValidation: {
        type: (...args) => this.onTypeChanged(...args),
        tag_language: (...args) => this.onTagLanguageChanged(...args)
      }
    });
    ...
    return (
      <div className={this.state.elementInFullscreen ? "withElementInFullscreen" : ''}>
        ...
        <div className="alert alert-warning" role="alert">
          ...
          <>
                            {isEdit ?
            <StaticField id="type" className={"formDisabled"} label={t('type')}>
