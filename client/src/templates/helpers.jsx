...
}const MosaicoTemplateChangeModalDialog =
...
MosaicoTemplateChangeModalDialog extends Component {
  constructor() {
    super();
    ...
    this.hideModalHandler = (...args) => this.hideModal(...args);
    this.performActionHandler = (...args) => this.performAction(...args);
  }
