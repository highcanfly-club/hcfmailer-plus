...
import {
  ...
  StaticField,
  withForm,
  wrapWithFormErrorHandlers } from
'../lib/form';
...
import { Trans } from "react-i18next";const CustomContent =
...
CustomContent extends Component {
  constructor(props) {
    super(props);
    this.submitHandler = wrapWithFormErrorHandlers(this, this.submitHandler);
    ...
    this.initForm({
      ...
      getPreSubmitUpdater: (...args) => this.getPreSubmitFormValuesUpdater(...args),
      onChangeBeforeValidation: {
        data_sourceCustom_tag_language: (...args) => this.onTagLanguageChanged(...args)
      }
    });

    this.sendModalGetDataHandler = (...args) => this.sendModalGetData(...args);
    this.exportModalGetContentHandler = (...args) => this.exportModalGetContent(...args);
  ...
  render() {
    ...
    return (
      <div className={this.state.elementInFullscreen ? "withElementInFullscreen" : ''}>
                <TestSendModalDialog
        ...
        <div className="alert alert-warning" role="alert">
                ...
                <Form stateOwner={this} onSubmitAsync={(...args) => this.submitHandler(...args)}>
                    <StaticField id="data_sourceCustom_type" className={"formDisabled"} label={t('customTemplateEditor')}>
