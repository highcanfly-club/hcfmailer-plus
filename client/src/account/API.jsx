...
export default function API() {
    ...
    let accessTokenMsg;
    if (accessToken) {
        accessTokenMsg = <div>{t('personalAccessToken') + ': '}<code>{token}</code></div>;
    } else {
            ...
            <div className="card mb-3">
                <div className="card-body">
                    <div className="float-right">
                        <Button label={accessToken ? t('resetAccessToken') : t('generateAccessToken')} icon="redo" className="btn-info" onClickAsync={resetAccessToken} />
                    </div>
                    {accessTokenMsg}
                </div>
            </div>
        ...
        <div id="moresubscribers" className="collapse" data-parent="#apicalls">
            <div className="card-body">
               <p>
                ...
                <pre>curl -XGET '{getUrl(`api/subscriptions/P5wKkz-e7?access_token=${token}&limit=10&start=10&search=gmail`)}' </pre>
    ...
    <div className="card">
        ...
        <div id="moresubscribe" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/subscribe/B16uVTdW?access_token=${token}`)}' \<br/>
    ...
    <div className="card">
        ...
        <div id="moreunsubscribe" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/unsubscribe/B16uVTdW?access_token=${token}`)}' \<br/>
    ...
    <div className="card">
        ...
        <div id="moredelete" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/delete/B16uVTdW?access_token=${token}`)}' \<br/>
--data 'EMAIL=test@example.com'</pre>
                <p>
                    {t('responseExample')}:
                </p>
    ...
    <div className="card">
        ...
        <div id="morefield" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/field/B16uVTdW?access_token=${token}`)}' \<br/>
        ...
        <div id="moreblacklistget" className="collapse" data-parent="#apicalls">
            <div className="card-body">
               <p>
                ...
                <pre>curl -XGET '{getUrl(`api/blacklist/get?access_token=${token}&limit=10&start=10&search=gmail`)}' </pre>
    ...
    <div className="card">
        ...
        <div id="moreblacklistadd" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/blacklist/add?access_token=${token}`)}' \<br/>
--data 'EMAIL=test@example.com'</pre>
            </div>
        </div>
    </div>
    <div className="card">
        ...
        <div id="moreblacklistdelete" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/blacklist/delete?access_token=${token}`)}' \<br/>
--data 'EMAIL=test@example.com'</pre>
            </div>
        </div>
    </div>
    <div className="card">
        ...
        <div id="morelistsemail" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XGET '{getUrl(`api/lists/test@example.com?access_token=${token}`)}'</pre>
            </div>
        </div>
    </div>
    <div className="card">
        ...
        <div id="morelistsnamespace" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XGET '{getUrl(`api/lists-by-namespace/1?access_token=${token}`)}'</pre>
            </div>
        </div>
    </div>
    <div className="card">
        ...
        <div id="morecreatelist" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/list?access_token=${token}`)}' \<br/>
                  -d 'NAMESPACE=1' \<br/>
    ...
    <div className="card">
        ...
        <div id="moredeletelist" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XDELETE '{getUrl(`api/list/WSGjaP1fY?access_token=${token}`)}'</pre>
                <p>
                    {t('responseExample')}:
                </p>
    ...
    <div className="card">
        ...
        <div id="morerss" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XGET '{getUrl(`api/rss/fetch/5OOnZKrp0?access_token=${token}`)}'</pre>
            </div>
        </div>
    </div>
    <div className="card">
        ...
        <div id="moretemplate" className="collapse" data-parent="#apicalls">
            <div className="card-body">
                ...
                <pre>curl -XPOST '{getUrl(`api/templates/1/send?access_token=${token}`)}' \<br/>
