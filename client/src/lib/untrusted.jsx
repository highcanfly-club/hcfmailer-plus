...
import { withComponentMixins } from "./decorator-helpers";const UntrustedContentHost =
...
['ask'])(class
UntrustedContentHost extends Component {
  constructor(props) {{
      super(props);
      ...
      this.receiveMessageHandler = (...args) => this.receiveMessage(...args);
    ...
    }this.refreshAccessToken = wrapWithAsyncErrorHandler(this, this.refreshAccessToken);}
  ...
  render() {
    return (
      ...
      <iframe className={"untrustedContent" + ' ' + this.props.className} height="40px" ref={this.contentNodeRefHandler} src={getSandboxUrl(this.props.contentSrc)} onLoad={(...args) => this.contentNodeLoaded(...args)}></iframe>);

  }
});export { UntrustedContentHost };
...
}const UntrustedContentRoot =

withComponentMixins([
withTranslation]
)(class
UntrustedContentRoot extends Component {
  constructor(props) {
    super(props);
    ...
    this.periodicTimeoutHandler = (...args) => this.onPeriodicTimeout(...args);
