...
import { withComponentMixins } from "./decorator-helpers";const CKEditorSandbox =


withComponentMixins([
withTranslation]
)(class
CKEditorSandbox extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    parentRPC.setMethodHandler('setHeight', (...args) => this.setHeight(...args));
  }
