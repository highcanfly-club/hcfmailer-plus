...
Table extends Component {
  constructor(props) {{{
      ...
      }this.fetchData = wrapWithAsyncErrorHandler(this, this.fetchData);}this.fetchAndNotifySelectionData = wrapWithAsyncErrorHandler(this, this.fetchAndNotifySelectionData);}
  ...
  updateSelectInfo() {
    ...
    if (this.selectionMap.size > 0) {
      ...
      const jqDeselectLink = jQuery('<a href="">Deselect all.</a>').on('click', (...args) => this.deselectAll(...args));
  ...
  componentDidMount() {
    ...
    const dtOptions = {
      ...
      "<'row'<'col-sm-12'<'" + "dataTableTable" + "'tr>>>" +
