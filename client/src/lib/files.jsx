...
import { withComponentMixins } from "./decorator-helpers";const Files =
  ...
  render() {
    ...
    return (
      <div>
          ...
          onCloseAsync={(...args) => this.hideDeleteFile(...args)}
          buttons={[
          { label: t('no'), className: 'btn-primary', onClickAsync: (...args) => this.hideDeleteFile(...args) },
          { label: t('yes'), className: 'btn-danger', onClickAsync: (...args) => this.performDeleteFile(...args) }]
          }>
