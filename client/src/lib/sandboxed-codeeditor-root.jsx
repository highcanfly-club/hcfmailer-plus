...
const refreshTimeout = 1000;const CodeEditorSandbox =

withComponentMixins([
withTranslation]
)(class
CodeEditorSandbox extends Component {
  constructor(props) {
    super(props);
    ...
    this.onCodeChangedHandler = (...args) => this.onCodeChanged(...args);

    this.refreshHandler = (...args) => this.refresh(...args);
    this.refreshTimeoutId = null;

    this.onMessageFromPreviewHandler = (...args) => this.onMessageFromPreview(...args);
  ...
  componentDidMount() {
    parentRPC.setMethodHandler('exportState', (...args) => this.exportState(...args));
    parentRPC.setMethodHandler('setPreview', (...args) => this.setPreview(...args));
    parentRPC.setMethodHandler('setWrap', (...args) => this.setWrap(...args));
  ...
  render() {
    ...
    return (
      <div className="sandbox">
                <div className={this.state.preview ? 'aceEditorWithPreview' : 'aceEditorWithoutPreview'}>
                    <ACEEditorRaw
            mode="html"
            theme="github"
            width="100%"
