...
import "./sandboxed-ckeditor.scss";
...
withTranslation],
['exportState'])(class
CKEditorHost extends Component {
  constructor(props) {
    super(props);
    ...
    this.onWindowResizeHandler = (...args) => this.onWindowResize(...args);
  ...
  render() {
    ...
    return (
      <div className={this.state.fullscreen ? "editorFullscreen" : "editor"}>
                ...
                <UntrustedContentHost ref={this.contentNodeRefHandler} className={"host"} singleToken={true} contentProps={editorData} contentSrc="ckeditor/editor" tokenMethod="ckeditor" tokenParams={editorData} />
            </div>);
